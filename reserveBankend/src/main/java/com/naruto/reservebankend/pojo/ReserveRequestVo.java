...
public class ReserveRequestVo {
    ...
    public ReserveRequestVo() {
    }

    public ReserveRequestVo(String wx_session_user_id, String service_id, String service_record_id, Record service_record, List<Object> child_service_records, String code) {
